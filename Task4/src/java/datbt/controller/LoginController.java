...
public class LoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        AccountDTO acc = accDAO.checkLogin(user, pass);
        if (acc == null) {
            request.setAttribute(Constants.MES_LOGIN, "Username/Password is wrong!");
        ...
        session.setAttribute(Constants.ACC_INFOR, acc);
