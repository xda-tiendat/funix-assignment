        ...
        <div class="w3-main" style="margin-left:300px">
            ...
            <form action="UpdatePostController" method="POST">
                <div class="w3-container w3-padding-large" style="margin-bottom:32px;background-color: white;border: 1px solid #BBB;">
                    ...
                    <input class="w3-input w3-border" type="text" name="txtTitle" value="${postById.title}" required>
                    <br/>
                    <textarea class="w3-input w3-border textedit" name="txtSummary" required>${postById.summary}</textarea>
                    <br/>
                    <textarea class="col-lg-12 nopadding" id="txtEditor" name="txtEditor" type>${postById.description}</textarea> 
                    <br/>
